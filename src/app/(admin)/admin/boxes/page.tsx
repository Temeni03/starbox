    ...
    <div className="space-y-6 pb-20 sm:pb-0">
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
        <div className="bg-white p-5 rounded-2xl shadow-sm border border-neutral-200 flex flex-col gap-1">
          <span className="text-label-sm uppercase tracking-wider text-neutral-400">{t('totalBoxes')}</span>
        ...
        <div className="bg-brand-container/20 p-5 rounded-2xl shadow-sm border border-brand-primary/10 flex flex-col gap-1">
          <span className="text-label-sm uppercase tracking-wider text-brand-secondary">{t('visible')}</span>
          <span className="text-headline-xl text-brand-secondary">{metrics.visible}</span>
        </div>
        <div className="bg-status-pending/10 p-5 rounded-2xl shadow-sm border border-status-pending/20 flex flex-col gap-1">
          <span className="text-label-sm uppercase tracking-wider text-status-pending">{t('hidden')}</span>
          <span className="text-headline-xl text-status-pending">{metrics.hidden}</span>
        </div>
        <div className="bg-danger/10 p-5 rounded-2xl shadow-sm border border-danger/20 flex flex-col gap-1">
          <span className="text-label-sm uppercase tracking-wider text-danger">{t('totalValue')}</span>
          <span className="text-headline-xl text-danger">{metrics.totalValue.toLocaleString()} MRU</span>
        </div>
      </div>
            ...
            return (
              ...
              >
                ...
                <div className="flex items-center gap-1 shrink-0">
                  ...
                  >
                    <Icon name={b.isActive ? 'visibility_off' : 'visibility'} size={16} />
                  </button>
                  <button
