  ...
  return (
    <div className="pb-28 sm:pb-6 max-w-lg mx-auto">
      ...
      <div className="bg-white -mt-6 relative z-10 rounded-t-3xl shadow-xl shadow-brand-primary/5 p-5">
        ...
        {!outOfStock && (
          <div className="mb-6">
            <label className="text-xs font-medium text-neutral-500 block mb-2">Quantity</label>
        ...
        {product.description && (
          <div className="mb-6">
            <h2 className="text-sm font-semibold text-neutral-800 mb-1.5">Description</h2>
        ...
        {product.usageInstructions && (
          <div className="mb-6">
            <h2 className="text-sm font-semibold text-neutral-800 mb-1.5">How to use</h2>
        ...
        {product.video && (
          <div className="mb-6">
            <h2 className="text-sm font-semibold text-neutral-800 mb-1.5">Product video</h2>
        ...
        {recommended.length > 0 && (
          <div>
            <h2 className="text-base font-semibold text-neutral-800 mb-3">You May Also Like</h2>
